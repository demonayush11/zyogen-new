...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div ref={ref} className={cn("fixed inset-x-0 top-2 z-50 w-full", className)}>
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-xl border border-white/10 bg-black px-4 py-6 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05)]",
            className,
          )}
        >
          {children}
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    primary:
      "bg-cyan-400 text-black shadow-[0_0_24px_rgba(34,_42,_53,_0.06)]",
